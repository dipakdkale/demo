          ...
          <div class="box box-primary">
            ...
            <form role="form" name="<?php echo $FormName; ?>" method="post" action="" enctype="multipart/form-data">
              <div class="box-body">
                  ...
                  <label for="filess">Logo image</label>
                  <input type="file" id="filess" name="filess">
                  <img src="../images/<?php echo $row['image_url'];?>" style="width:100px; height:60px;"/>
                </div>
                <div class="form-group">
                  <label for="website_name">Website name</label>
                  <input type="text" class="form-control" id="website_name" placeholder="website name" name="website_name" value="<?php echo $row['website_name'];?>">
                </div>
                <div class="form-group">
                  <label for="website_name">Tag Line</label>
                  <input type="text" class="form-control" id="tag_line" placeholder="Tag Line" name="tag_line" value="<?php echo $row['tag_line'];?>">
                </div>
                <div class="form-group">
                  <label for="website_name">Phone Tag Line</label>
                  <input type="text" class="form-control" id="phone_tag_line" placeholder="Phone Tag Line" name="phone_tag_line" value="<?php echo $row['phone_tag_line'];?>">
                </div>
                <div class="form-group">
                  <label for="website_url">Website url</label>
                  <input type="text" class="form-control" id="website_url" placeholder="website url" name="website_url" value="<?php echo $row['website_url'];?>">
                </div>
                <div class="form-group">
                  <label for="homepage_title">Homepage Title</label>
                  <input type="text" class="form-control" id="homepage_title" placeholder="Homepage Title" name="homepage_title" value="<?php echo $row['homepage_title'];?>">
                </div>
                <div class="form-group">
                  <label for="homepage_keyword">Homepage Keyword</label>
                  <input type="text" class="form-control" id="homepage_keyword" placeholder="Homepage Keywords" name="homepage_keyword" value="<?php echo $row['homepage_keyword'];?>">
                </div>
                
                <div class="form-group">
                  <label for="homepage_description">Homepage Description</label>
                  <input type="text" class="form-control" id="homepage_description" placeholder="Homepage Description" name="homepage_description" value="<?php echo $row['homepage_description'];?>">
                </div>
                
				<div class="form-group">
                  <label for="phone1">Phone 1</label>
                  <input type="text" class="form-control" id="phone1" placeholder="Phone 1" name="phone1" value="<?php echo $row['phone1'];?>">
                </div>
				
                <div class="form-group">
                  <label for="email1">Email For Website</label>
                  <input type="text" class="form-control" id="email1" placeholder="Email For Website" name="email1" value="<?php echo $row['email1'];?>">
                </div>
                
                <div class="form-group">
                  <label for="email2">Email For Getting Request</label>
                  <input type="text" class="form-control" id="email2" placeholder="Email For Getting Request" name="email2" value="<?php echo $row['email2'];?>">
                </div>
                <?php /*?><div class="form-group">
                  <label for="email3">Email For Paypal</label>
                  <input type="text" class="form-control" id="email3" placeholder="Email For Paypal" name="email3" value="<?php echo $row['paypalemail'];?>">
                </div><?php */?>
                
                <div class="form-group">
                  <label>Address</label>
                  <textarea placeholder="Enter ..." rows="3" class="form-control" name="address" id="address"><?php echo $row['address']; ?></textarea>
                </div>
                
                <div class="form-group">
                  <label for="facebook_link">Facebook Link</label>
                  <input type="text" class="form-control" id="facebook_link" placeholder="Facebook Link" name="facebook_link" value="<?php echo $row['facebook_link'];?>">
                </div>
                <div class="form-group">
                  <label for="twitter_link">Twitter Link</label>
                  <input type="text" class="form-control" id="twitter_link" placeholder="Twitter Link" name="twitter_link" value="<?php echo $row['twitter_link'];?>">
                </div>
                <div class="form-group">
                  <label for="linkedin_link">LinkedIn Link</label>
                  <input type="text" class="form-control" id="linkedin_link" placeholder="LinkedIn Link" name="linkedin_link" value="<?php echo $row['linkedin_link'];?>"> 
                </div>
                <div class="form-group">
                  <label for="googleplus_link">Googleplus Link</label>
                  <input type="text" class="form-control" id="googleplus_link" placeholder="Googleplus Link" name="googleplus_link" value="<?php echo $row['goggleplus_link'];?>">
                </div>
                <div class="form-group">
                  <label for="googleplus_link">Form Heading</label>
                  <input type="text" class="form-control" id="form_heading" placeholder="Form Heading" name="form_heading" value="<?php echo $row['form_heading'];?>">
                </div>
                <div class="form-group">
                  <label for="googleplus_link">Section 1 Arrow Heading</label>
                  <input type="text" class="form-control" id="arrow_heading" placeholder="Arrow Heading" name="arrow_heading" value="<?php echo $row['arrow_heading'];?>">
                </div>
                
                <div class="form-group">
                  <label for="googleplus_link">Section 3 Heading</label>
                  <input type="text" class="form-control" id="section3_heading" placeholder="Section 3 Heading" name="section3_heading" value="<?php echo $row['section3_heading'];?>">
                </div>
                <div class="form-group">
                  <label for="googleplus_link">Section 4 Heading</label>
                  <input type="text" class="form-control" id="section4_heading" placeholder="Section 4 Heading" name="section4_heading" value="<?php echo $row['section4_heading'];?>">
                </div>
                <div class="form-group">
                  <label for="googleplus_link">Section 5 Heading</label>
                  <input type="text" class="form-control" id="section5_heading" placeholder="Section 5 Heading" name="section5_heading" value="<?php echo $row['section5_heading'];?>">
                </div>
                 <div class="form-group">
                  <label for="googleplus_link">Section 6 Heading</label>
                  <input type="text" class="form-control" id="section6_heading" placeholder="Section 6 Heading" name="section6_heading" value="<?php echo $row['section6_heading'];?>">
                </div>
                 <div class="form-group">
                  <label for="googleplus_link">Section 7 Heading</label>
                  <input type="text" class="form-control" id="section7_heading" placeholder="Section 7 Heading" name="section7_heading" value="<?php echo $row['section7_heading'];?>">
                </div>
                <div class="form-group">
                  <label for="googleplus_link">Footer Content</label>
                  <input type="text" class="form-control" id="footer_content" placeholder="Footer Content" name="footer_content" value="<?php echo $row['footer_content'];?>">
                </div>
                
                
                <?php /*?><div class="form-group">
                  <label for="youtube_link">YouTube Link</label>
                  <input type="text" class="form-control" id="youtube_link" placeholder="YouTube Link" name="youtube_link" value="<?php echo $row['youtube_link'];?>">
                </div><?php */?>
				
				<?php /*?><div class="form-group">
                  <label for="url_point">Point</label>
                  <input type="text" class="form-control" id="url_point" placeholder="Point" name="url_point" value="<?php echo $row['url_point'];?>">
                </div><?php */?>
				
				<?php /*?><div class="form-group">
                  <label for="refer_point">Refer Point</label>
                  <input type="text" class="form-control" id="url_point" placeholder="Refer Point" name="refer_point" value="<?php echo $row['refer_point'];?>">
                </div><?php */?>
				
				<?php /*?><div class="form-group">
                  <label for="currency_code">Currency Code</label>
                  <input type="text" class="form-control" id="currency_code" placeholder="Currency Code" name="currency_code" value="<?php echo $row['currency_code'];?>">
                </div><?php */?>
				
				<?php /*?><div class="form-group">
                  <label for="drawnValue">Competition drawn value</label>
                  <input type="text" class="form-control" id="drawnValue" placeholder="Competition drawn value" name="drawnValue" value="<?php echo $row['drawnValue'];?>">
                </div><?php */?>
              ...
              <div class="box-footer">
                <button type="submit" name="submit" value="Submit" onclick="return <?php echo $ValidationFunctionName?>();" class="btn btn-primary">Submit</button>
              </div>
            </form>
          </div>
          <!-- /.box -->
			...
			case 'server':
						...
						$this->goggleplus_link=$googleplus_link;
						$this->map=$map;
						...
						$this->arrow_heading=$arrow_heading;
						$this->section3_heading=$section3_heading;
						$this->section4_heading=$section4_heading;
						$this->section5_heading=$section5_heading;
						$this->section6_heading=$section6_heading;
						$this->section7_heading=$section7_heading;
						$this->footer_content=$footer_content;
						$this->phone_tag_line=$phone_tag_line;
						...
						if($this->Form->ValidField($website_name,'empty','Please Enter Website Name')==false)
							...
							$update_sql_array['paypalemail'] = $this->email3;
							...
							$update_sql_array['form_heading'] = $this->form_heading;
							$update_sql_array['arrow_heading']   = $this->arrow_heading;
							$update_sql_array['section3_heading']   = $this->section3_heading;
							$update_sql_array['section4_heading']   = $this->section4_heading;
							$update_sql_array['section5_heading']   = $this->section5_heading;
							$update_sql_array['section6_heading']   = $this->section6_heading;
							$update_sql_array['section7_heading']   = $this->section7_heading;
							$update_sql_array['footer_content']   = $this->footer_content;
							$update_sql_array['tag_line']   = $this->tag_line;
							$update_sql_array['phone_tag_line']   = $this->phone_tag_line;
