...
include_once("function/class.spoilage.php");
$spoilage_obj=new Spoilage();
    ...
    <body>
        ...
        <section class="content">
			...
			switch($index)
			{
				case 'addpage':
				if($submit=="Submit")
				$spoilage_obj->addpage('server');
				else
				$spoilage_obj->addpage('local');				
				break;
				case 'editpage':
				if($submit=="Submit")
				$spoilage_obj->editpage('server',$id);
				else
				$spoilage_obj->editpage('local',$id);	
				break;
				default:
				$spoilage_obj->allpage();
			}
			?>
            </div>
            <!-- Page Content Ends -->
...
<?php $homepage->deletePage(TBL_SPOILAGE);?>
<script>
