	...
	<section class="content">
		...
		<a href="pos_table.php"  class="btn btn-purple btn-rounded m-b-5 pull-right" style="margin-top:0;"> <i class="fa fa-arrow-left" aria-hidden="true"></i> All Tables</a>
			...
			<div class="row"> 
				...
				<div class="col-md-12"><h4>New KOTs Not Printed</h4></div>
				<div class="col-md-12" id="div_kot">
				<?php $homepage->newKots($tbl_id);?>
			</div> 
				<div class="col-md-12"><h4>Printed KOTs</h4></div>
 ...
 <?php
	...
	<!--<script type="text/javascript">
		...
		frameDoc.document.open();
        	...
        	window.frames["frame1"].focus();
        	window.frames["frame1"].print();
        	window.location="pos_table.php?index=order_done&tbl_id=<?php $homepage->newKots($tbl_id);?>";
        }, 500);
