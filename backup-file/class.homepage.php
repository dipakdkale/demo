...
<nav class=" navbar-default hidden-xs" role="navigation">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="http://coderthemes.com/velonic_3.0/admin/" target="_blank">Login Screen</a></li>
                    </ul>
                </nav>
                <!-- Search -->
...
<li><span class="badge bg-warning" style="font-size:14px !important;"<strong>Current Date:</strong> <?php echo date('d-m-Y',time());?></span></li>
    ...
    <li title="Click here to close the day's  Transaction.!"><a href="javascript:void(0);" style="cursor:pointer;"><span class="badge bg-inverse" style="font-size:14px !important;" id="increase_date"><i class="ion-clock"></i></span></a></li>
    ...
    <a data-toggle="dropdown" class="dropdown-toggle" style="cursor:pointer" aria-expanded="true">
     ...
     <span class="badge badge-sm up bg-pink count">5</span>
    </a>
				    ...
				    <th>Bill Date</th>
			  	   ...
			  	   <td><?php echo date('d-m-Y',strtotime($row['timestamp']));?></td>
                                   ...
                                   <td><?php echo $this->getUserDetailById($row['user_id'],'fname');?></td>
                                                                       <td>
 		<a class="btnPrint" id="<?php echo $row[id];?>" title="Print" rel="tooltip" data-placement="top"> <i class="fa fa-print"><value="btnPrint"/></i></a> 
 		!
