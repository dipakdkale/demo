...
<div class="panel-body"> 
  ...
  <span class="slider round"></span>
            ...
            <button class="btn btn-icon btn-danger m-b-5 pull-right" title="Delete Menu Item"> <i class="fa fa-remove"></i> </button>
             <a href="product.php?index=edit&id=<?php echo $row['id'];?>" class="btn btn-icon btn-success m-b-5 pull-right" title="Edit Product"> 					<i class="fa fa-edit"></i> </a>
 </div>
<?php 
}
            ...
            <table class="table table-bordered">
                ...
                ?>
                    <tr class="tbl_row">
                        ...
                        <td>
                        <a href="javascript:;" data-id="<?php echo $row['id'];?>" class="md-trigger btn btn-warning btn-sm btn_ing_edit" data-modal="modal-13"><i class="fa fa-edit"></i>
                                        </a> | 
    ...
    <div class="panel panel-color panel-warning">
        ...
        <form class="form-inline" role="form" action="" method="post">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" title="Ingradient" id="ingradient" autocomplete="off" placeholder="Enter Ingradient...">
        ...
        <div class="panel-body"> 
            <form class="form-horizontal" action="" method="post" role="form">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                     <span class="badge bg-purple" id="span_ungradient_name" style="font-size:20px !important ;"></span>
...
<?php 
	...
	$this->db->update(TBL_PRODUCT_INGRADIENT,$update_sql_array,'id',$this->ing_id);
	$last_id=$this->db->last_insert_id();
        ...
        <div class="panel panel-color panel-purple" style="padding:2px !important;">
            ...
            <div class="panel-body"> 
              ...
              <span class="badge bg-danger">Old Selling Price :<?php echo $row['selling_price'];?></span>
                <div class="form-group">
                    <label for="selling_price" class="col-sm-6 control-label">Selling Price Without Tax</label>
                    <div class="col-sm-6">
                      <input type="text" name="selling_price_without_tax" required style="text-align:right;" class="form-control" value="" id="selling_price_without_tax"  placeholder="Enter..">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <input type="text" class="form-control" style="text-align:right;" data-id="<?php echo $this->getTaxDetail($row['tax_slab'],'percentage');?>"   name="tax_slab_amt" value="" readonly="readonly" id="tax_percentage" placeholder="Enter...">
                  
                    </div>
                </div>
                <div class="form-group">
                    <label for="ingradient" class="col-sm-6 control-label">Selling Price With Tax</label>
                    <div class="col-sm-6">
                      <input type="text" class="form-control" style="text-align:right;"  required name="selling_price" value="" readonly="readonly" id="selling_price" placeholder="Enter...">
