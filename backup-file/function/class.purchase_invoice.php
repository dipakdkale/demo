        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">All Requisition Invoices</h3>
                 <a href="purchase_invoice.php?index=add" class="btn btn-success m-b-5 pull-right" style="margin-top:-25px;">Add Requisition Invoice</a>
            </div>
          <a href="#" onclick="return print()" title="Print" class="tip"><span class="icon12 icomoon-icon-printer-2 tip"></span></a>
                        ...
                        <table class="table table-bordered">
                            ...
                            ?>
                                <tr class="tbl_row">
                                    ...
                                    <td><?php echo $this->getMoreDetail(tbl_department,$row['department_id']);?></td>
                                    ...
                                    <<td><?php echo $this->getUserDetail($row['$id']);?></td>
                                    <td><?php echo $row['status'];?></td>
                                    <td> <input type="button" onclick="window.print()" value="Print" /></td>
                                     <td> <input type="button" onclick="window.print($row[id]")" value="Edit" /></td>
                                     <TD> <class=edit> <input class=edit type=submit name=update value=edit>/<TD>
                                    <td>
                                    <?php if($row['status']=='Save'){ ?>
               <a href="javascript:void(0);" disabled title="Resume this purchase Invoice." rel="tooltip" data-placement="top"><i class="fa fa-play"></i></a>  
        ...
        <div class="col-md-120">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-3">
                    	<div class="form-group">
                        <label for="sender_department_id">Department Name</label>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-12">
                    <div class="form-group">
                            <label for="brand_id">Purchase Invoice Number</label>
                    ...
                    <div class="col-md-8">
                     <button type="button" id="add_item" class="btn btn-icon btn-purple m-b-5 add-row"> <i class="fa fa-paper-plane-o"></i> ADD ROW</button>
                      </div>
                    <div class="panel-body">
                <div class="row">
