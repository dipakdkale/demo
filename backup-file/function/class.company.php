        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">All Companies</h3>
                 <a href="manage_company.php?index=add" class="btn btn-success m-b-5 pull-right" style="margin-top:-25px;">Add Company</a>
            </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            ?>
                                <tr class="tbl_row">
                                    ...
                                    <td>
               <a href="manage_company.php?index=edit&id=<?php echo $row['id'];?>" title="Edit" rel="tooltip" data-placement="top"><i class="fa fa-edit"></i></a>  
