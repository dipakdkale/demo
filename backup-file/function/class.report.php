...
<div class="row"  id="div_print">
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <h2>Sale By Mode Of Settlement</h2>
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <table class="table table-bordered">
							...
							<tr class="tbl_row">
                                    ...
                                    <td>Cash</td>
                                    <td><?php echo $this->SearchFilterForAmount($date_from,$date_to,'cash')-$this->SearchFilterForTaxAmount($date_from,$date_to,'cash');?></td>
                                     <td><?php echo round($this->SearchFilterForTaxAmount($date_from,$date_to,'cash'),2);?></td>
                                     <td><?php echo round($this->SearchFilterForAmount($date_from,$date_to,'cash'),2);?></td>
                                ...
                                <tr class="tbl_row">
                                    ...
                                    <td>Card</td>
                                    <td><?php echo $this->SearchFilterForAmount($date_from,$date_to,'card')-$this->SearchFilterForTaxAmount($date_from,$date_to,'card');?></td>
                                     <td><?php echo round($this->SearchFilterForTaxAmount($date_from,$date_to,'card'),2);?></td>
                                     <td><?php echo round($this->SearchFilterForAmount($date_from,$date_to,'card'),2);?></td>
                                ...
                                <tr class="tbl_row">
                                    ...
                                    <td>E-Wellet</td>
                                     <td><?php echo $this->SearchFilterForAmount($date_from,$date_to,'wallet')-$this->SearchFilterForTaxAmount($date_from,$date_to,'wallet');?></td>
                                     <td><?php echo round($this->SearchFilterForTaxAmount($date_from,$date_to,'wallet'),2);?></td>
                                     <td><?php echo round($this->SearchFilterForAmount($date_from,$date_to,'wallet'),2);?></td>
                                ...
                                <tr>
                               		<th>TOTAL :</th>
                                    <th><?php echo ($this->SearchFilterForAmount($date_from,$date_to,'cash')-$this->SearchFilterForTaxAmount($date_from,$date_to,'cash'))+($this->SearchFilterForAmount($date_from,$date_to,'card')-$this->SearchFilterForTaxAmount($date_from,$date_to,'card'))+($this->SearchFilterForAmount($date_from,$date_to,'wallet')-$this->SearchFilterForTaxAmount($date_from,$date_to,'wallet'));?></th>
                                    <th><?php echo (round($this->SearchFilterForTaxAmount($date_from,$date_to,'cash'),2))+(round($this->SearchFilterForTaxAmount($date_from,$date_to,'card'),2))+(round($this->SearchFilterForTaxAmount($date_from,$date_to,'wallet'),2));?></th>
                                    <th><?php echo (round($this->SearchFilterForAmount($date_from,$date_to,'cash'),2))+(round($this->SearchFilterForAmount($date_from,$date_to,'card'),2))+(round($this->SearchFilterForAmount($date_from,$date_to,'wallet'),2));?></th>
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th>Quantity</th>
                                    <th>Amount Without Tax (in Rs.)</th>
                                    <th>Tax Amount (in Rs.)</th>
                                     <th>Grand Total (in Rs.)</th>
                                    <th>Grand Total With Round Off (in Rs.)</th>
                                    <th>No. Of Bills</th>
                            ...
                            <tbody>
							<?php 
                            $sql="select * from ".TBL_PRODUCT." where 1 and brand_id='".$_SESSION['brand_id']."' order by id desc" ;
                            $result= $this->db->query($sql,__FILE__,__LINE__);
                            $x=1;
							$selling_price=0;
							$quantity=0;
							...
							<tr class="tbl_row">
                                    ...
                                    <td><?php echo $row['name']?></td>
                                    <td><?php echo $row['selling_price'];$selling_price+=$row['selling_price'];?></td>
                                    <td><?php echo $this->SearchFilterForItemQuantity($date_from,$date_to,$row['id'],'item_id');$quantity+=$this->SearchFilterForItemQuantity($date_from,$date_to,$row['id'],'item_id');?></td>
                                    <td><?php echo $this->SearchFilterForCategoryAmount($date_from,$date_to,$row['id'],'item_id')-$this->SearchFilterForCategoryTaxAmount($date_from,$date_to,$row['id'],'item_id');$without_tax_amt+=$this->SearchFilterForCategoryAmount($date_from,$date_to,$row['id'],'item_id')-$this->SearchFilterForCategoryTaxAmount($date_from,$date_to,$row['id'],'item_id');?></td>
                                     <td><?php echo round($this->SearchFilterForCategoryTaxAmount($date_from,$date_to,$row['id'],'item_id'),2);$tax_amt+=round($this->SearchFilterForCategoryTaxAmount($date_from,$date_to,$row['id'],'item_id'),2)?></td>
                                     <td><?php echo round($this->SearchFilterForCategoryAmount($date_from,$date_to,$row['id'],'item_id'),2);$with_tax_amt+=round($this->SearchFilterForCategoryAmount($date_from,$date_to,$row['id'],'item_id'),2);?></td>
                                     <td><?php echo round($this->SearchFilterForCategoryAmount($date_from,$date_to,$row['id'],'item_id'),0);$with_round+=round($this->SearchFilterForCategoryAmount($date_from,$date_to,$row['id'],'item_id'),0);?></td>
                                   
                                       <td><?php echo $this->SearchFilterForCategoryCount($date_from,$date_to,$row['id'],'item_id');$count2+=$this->SearchFilterForCategoryCount($date_from,$date_to,$row['id'],'item_id');?></td>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" method="get" action="report.php">
                            ...
                            <input type="text" class="form-control datepicker" required value="<?php echo $_REQUEST['date_from'];?>" name="date_from" placeholder="mm/dd/yyyy" id="datepicker">
                       		</div>
                       		<div class="col-md-4" style="margin:0;">
                            <strong>Date To:</strong>
                           
                            <input type="text" class="form-control datepicker" value="<?php echo $_REQUEST['date_to'];?>" name="date_to" placeholder="mm/dd/yyyy" id="datepicker2">
                        </div>
                        <div class="col-md-4" style="margin:0;">
                        <strong><br />
</strong>
