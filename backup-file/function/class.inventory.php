        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">All Items</h3>
                 <a href="manage_stock.php?index=add" class="btn btn-success m-b-5 pull-right"  style="margin-top:-25px;">Add Stock</a>
            </div>
            ...
            <div class="panel-body">
               ...
               |<a class="btn_delete" id="<?php echo $row[id];?>" ><i class="fa fa-ban"></i></a>  </td><?php */?>
                                </tr>
                             <?php $x++; }?>
                            </tbody>
                        </table>
