...
<div class="row">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">All Receiving Receipts </h3>
                 <a href="manage_receiving.php?index=add" class="btn btn-success m-b-5 pull-right" style="margin-top:-25px;">Add  Receiving Receipts</a>
            </div>
 ...
 <tr class="tbl_row">
                                    <td><?php echo $x;?></td>
                                     <td><?php echo $row['purchase_invoice_no'];?></td>
                                      <td><?php echo $row['transfer_invoice_no'];?></td>
                                       <td><?php echo $row['re_invoice_no'];?></td>
                                    ...
                                    <td>
             <a href="purchase_invoice.php?index=edit&id=<?php echo $row['id'];?>" title="Edit" rel="tooltip" data-placement="top"><i class="fa fa-edit"></i></a>  
