...
include_once("function/class.dashboard.php");
$report_obj=new Sale();
...
<head>
        ...
        <meta name="author" content="DIPOS">
...
<?php $notify->Notify();?>
		...
		<?php
                $submit = isset($_POST['submit']) ? $_POST['submit'] : ''; switch($index)
			{
				case 'addpage':
				if($submit=="Submit")
				...
				$report_obj->allpage($_REQUEST['date_from']);
				break;
				default:
				$report_obj->searchPanel();
			}
