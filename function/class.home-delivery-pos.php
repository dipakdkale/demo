...
<form action="" method="post">
        <div class="panel-body">
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <table class="table">
						...
						<?php 
                        $sql="select * from ".TBL_HOME_DELIVERY_ITEM_TEMP." where 1 and  customer_id='".$cus_id."' order by id desc" ;
                        $result= $this->db->query($sql,__FILE__,__LINE__);
                        $x=1;
               ...
               <?php 
				$sql2="select count(id) as total_quantity, sum(price) as amt from ".TBL_HOME_DELIVERY_ITEM_TEMP." where 1 and  customer_id='".$cus_id."'  order by id desc" ;
				$result2= $this->db->query($sql2,__FILE__,__LINE__);
				$row2 = $this->db->fetch_array($result2);
			   ?>
          ...
          <a href="all-customer.php?type=home_delivery" class="btn btn-warning m-b-5"> Hold </a>
       <?php if($bill_id=='') { ?>
...
//	echo $num_of_items;
	...
	$this->db->insert(TBL_HOME_DELIVERY_ORDER,$insert_sql_array);
	...
	$this->db->insert(TBL_HOME_DELIVERY_ITEM,$insert_sql_array);
	...
	$sql_delete="delete from ".TBL_HOME_DELIVERY_ITEM_TEMP." where customer_id='".$cus_id."' ";
	...
	window.location = "home-delivery-pos.php?tbl_id=<?php echo $tbl_id;?>&bill_id=<?php echo $this->last_id;?>&cus_id=<?php echo $cus_id;?>";
	</script>
...
<div class="panel-body">
            <div class="row">
                ...
                <tr><td ><strong>Cus No.:</strong> <?php echo $cus_id;?></td><td ></td><td ><strong>Px:</strong></td></tr>
                <tr><td ><strong>Wt:</strong> <?php echo $this->getUserDetail('fname')." ".$this->getUserDetail('lname');?></td><td ></td><td ><strong>Op:</strong></td></tr>
                    ...
                    <table >
                        ...
                        <tr class="" style=" border-bottom:1px dashed #000;" >
							...
							$sql2="select sum(quantity) as total_quantity,sum(price) as total_amount from ".TBL_HOME_DELIVERY_ITEM_TEMP." where 1 and  customer_id='".$cus_id."' order by id desc" ;
                    ...
                    <tr>
                        ...
                        <th>Net-Amt</th>
                                ...
                                $sql3="select sum(tax_slab_amt) as amt,sum(price) as price_sum from ".TBL_HOME_DELIVERY_ITEM_TEMP." where 1  and customer_id='".$cus_id."' and tax_slab='".$row['id']."' order by id desc" ;
                                $result3= $this->db->query($sql3,__FILE__,__LINE__);
                    ...
                    <tr>
                        ...
                        <th>Total</th>
                                ...
                                $sql3="select sum(tax_slab_amt) as amt,sum(price) as price_sum,tax_slab,sum(cost_price_without_tax) as price_without_tax from ".TBL_HOME_DELIVERY_ITEM_TEMP." where 1  and customer_id='".$cus_id."' and tax_slab='".$row['id']."' order by id desc" ;
                                $result3= $this->db->query($sql3,__FILE__,__LINE__);
                                $row3= $this->db->fetch_array($result3);
                                if($row3['amt']>0)
								{
...
function oldKots($tbl_id){
	$sql4="select * from ".TBL_KOT." where 1 and table_id='".$tbl_id."' and is_print_kot='yes'  " ;
...
function newKots($tbl_id){
	$sql4="select * from ".TBL_KOT." where 1 and table_id='".$tbl_id."' and is_print_kot='no'  " ;
    $result4= $this->db->query($sql4,__FILE__,__LINE__);
	while($row4	=	$this->db->fetch_array($result4))
	{
?>
