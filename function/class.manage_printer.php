        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">All Printers</h3>
                 <a href="manage_printer.php?index=addpage" class="btn btn-success m-b-5 pull-right" style="margin-top:-25px;">Category To Printer Mapping</a>
            </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            ?>
                                <tr class="tbl_row">
                                    ...
                                    <td>
               <a href="manage_printer.php?index=editpage&id=<?php echo $row['id'];?>" title="View and Edit Printer-Category Mapping" rel="tooltip" data-placement="top"><i class="fa fa-edit"></i></a>  
    ...
    <div class="col-md-6">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <input type="text" required class="form-control" name="printer_name" id="printer_name" placeholder="Printer Name">
