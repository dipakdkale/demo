        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">All Measurements</h3>
                 <a href="manage_measurement.php?index=addpage" class="btn btn-success m-b-5 pull-right" style="margin-top:-25px;">Add Measurement</a>
            </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            ?>
                                <tr class="tbl_row">
                                    ...
                                    <td>
               <a href="manage_measurement.php?index=editpage&id=<?php echo $row['id'];?>" title="Edit" rel="tooltip" data-placement="top"><i class="fa fa-edit"></i></a>  
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                           ...
                           <select name="unit_type" class="form-control" id="unit_type">
                                ...
                                <option value="mass" echo 'selected=selected';?>Mass</option>
                                <option value="volume" echo 'selected=selected';?>Volume</option>
                                <option value="count" echo 'selected=selected';?>Count</option>
                           </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" required class="form-control" name="base_unit" id="base_unit" placeholder="Base Unit">
                        </div>
                        <div class="form-group">
                            <label for="conversion">Conversion To Base Unit</label>
                            <input type="text" required class="form-control" name="conversion" id="conversion" placeholder="Conversion Unit">
                        </div>
                        <div class="form-group">
                         <label for="is_base_unit">Conversion To Base Unit</label>
                            <label class="cr-styled">
                                <input type="checkbox" id="is_base_unit" name="is_base_unit" <?php echo "checked";?> value="yes">
                                <i class="fa"></i> 
                                Yes
                            </label>
                       </div>
