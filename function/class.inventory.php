...
class Inventory{
    ...
    function getStockDetail($TBL_STOCK,$id){
    $sql="select * from ".$TBL_STOCK." where 1 and id='".$id."' order by name asc" ;
    $result= $this->db->query($sql,__FILE__,__LINE__);
    $row = $this->db->fetch_array($result);
    return $row['stock'];
    }
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">All Items</h3>
                 <a href="inventory.php?index=addpage" class="btn btn-success m-b-5 pull-right" style="margin-top:-25px;">Edit Closing Stock</a>
            </div>
                        ...
                        <table class="table table-hover">
                            ...
                            ?>
                                <tr class="tbl_row">
                                    ...
                                    <td><?php echo $this->getStockDetail(TBL_STOCK,$row['stock']);?></td>

                                    <td><?php echo $row['veg_or_non'];?></td>
                                    <td><?php echo $row['cost_price'];?></td>
                                    <td><?php echo $row['selling_price'];?></td>
                                    <td>
               <a href="manage_stock.php?index=edit&id=<?php echo $row['id'];?>" title="Edit" rel="tooltip" data-placement="top"><i class="fa fa-edit"></i></a>  
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" method="post" action="">
                        ...
                        <label class="control-label">Taxation</label>
                            ...
                            <div class="radio-inline">
                                <label class="cr-styled" for="taxation1">
                                    <input type="radio" id="taxation1" name="is_tax" value="yes"> 
                                    <i class="fa"></i>
                                    With Tax 
                                </label>
                            </div>
                            <div class="radio-inline">
                                <label class="cr-styled" for="taxation2">
                                    <input type="radio" id="taxation2" name="is_tax" value="no"> 
                                    <i class="fa"></i> 
                                    Without Tax
                                </label>
                            </div>
                        ...
                        <div class="form-group" id="div_tax" style="display:none;">
...
<?php 
	...
	$this->db->insert(TBL_MANGE_STOCK,$insert_sql_array);
...
<div class="wraper container-fluid">
	...
	$this->db->update(TBL_MANAGE_STOCK,$update_sql_array,'id',$id);
