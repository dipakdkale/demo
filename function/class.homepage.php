    ...
    <nav class="navigation">
        <ul class="list-unstyled">
           ...
           <li class="has-submenu <?php if($page=='inventoy' || $page=='supplier') echo 'active';?> "><a href="#"><i class="fa fa-archive	"></i> <span class="nav-label">Manage Inventory</span></a>
                <ul class="list-unstyled">
                    <li class="<?php if($page=='stock') echo 'active';?>"><a href="manage_stock.php">Closing Stock</a></li>
		   ...
		   <li class="<?php if($page=='spoilage') echo 'active';?>"><a href="spoilage.php">Manage Spoilage</a></li>                    
            ...
            <li class="has-submenu <?php if($page=='sale' || $page=='report'|| $page=='report'|| $page=='report') echo 'active';?> "><a href="#"><i class="fa fa-archive	"></i> <span class="nav-label">Reports</span></a>
            <ul class="list-unstyled">
            <li class="<?php if($page=='sale') echo 'active';?>"><a href="sale.php">Sale Report</a></li>
             <li class="<?php if($page=='report') echo 'active';?>"><a href="report.php">Report</a></li>
       ...
       <?php if($_SESSION['user_type']=='sadmin' || $_SESSION['user_type']=='company_admin') { ?>
         ...
         <?php /*<li class="has-submenu"><a href="#"><i class="ion-location"></i> <span class="nav-label">Maps</span></a>
                <ul class="list-unstyled">
...
<nav class=" navbar-default hidden-xs" role="navigation">
	...
	<li><span class="badge bg-warning" style="font-size:18px !important;"<strong>Current Date:</strong> <?php echo date('d-m-Y',time());?></span></li>
	<li><span class="badge bg-success" style="font-size:18px !important;"><strong>Software Date:</strong> <?php echo date('d-m-Y',strtotime($this->getSoftwareDate()))?></span></li>
	<li title="Click here to close the day's  Transaction.!"><a href="javascript:void(0);" style="cursor:pointer;"><span class="badge bg-inverse" style="font-size:18px !important;" id="increase_date"><i class="ion-clock"></i></span></a></li>
</ul>
   ...
   <li><p>Company: <span class="badge bg-purple"><?php echo $this->getSoftwareDetail(TBL_COMPANY,$_SESSION['company_id'],'heading');?></span></p></li>
	...
	<li><a href="all-customer.php?type=take_away" class="btn btn-success" style="padding:5px 10px; margin-left:3px;"> <i class="fa fa-shop"></i> <span>TAKE AWAY </span> </a></li>
	<li><a href="all-customer.php?type=home_delivery" class="btn btn-primary" style="padding:5px 10px; margin-left:3px;"> <i class="fa fa-shop"></i> <span>HOME DELIVERY </span> </a></li>
        <li><a href="all-customer.php?type=home_delivery" class="btn btn-primary" style="padding:5px 10px; margin-left:3px;"> <i class="fa fa-shop"></i> <span>GST Bill</span> </a></li>
        <!-- /messages -->
        <!-- Notification -->
		...
		<li><a href="master_settings.php"><i class="fa fa-cog"></i> Settings</a></li>
		<li><a href="pos_table.php?index=old_bills"  class="btn btn-info" style="padding:5px 10px;margin-left:3px;" <i class="fa fa-calculator" aria-hidden="true"></i> Bills Register</a></li>
		<li><a href="pos_table.php" class="btn btn-info" style="padding:5px 10px;"> <i class="fa fa-shop"></i> <span>DINE</span> </a></li>
		<li><a href="all-customer.php?type=take_away" class="btn btn-success" style="padding:5px 10px; margin-left:3px;"> <i class="fa fa-shop"></i> <span>TAKE AWAY </span> </a></li>
		<li><a href="all-customer.php?type=home_delivery" class="btn btn-primary" style="padding:5px 10px; margin-left:3px;"> <i class="fa fa-shop"></i> <span>HOME DELIVERY </span> </a></li>
		<li><a href="all-customer.php?type=home_delivery" class="btn btn-primary" style="padding:5px 10px; margin-left:3px;"> <i class="fa fa-shop"></i> <span>GST Bill</span> </a></li>
...
$ValidationFunctionName="CheckaddpageValidity"; $JsCodeForFormValidation=$this->validity->ShowJSFormValidationCode($FormName,$ControlNames,$ValidationFunctionName);
echo $JsCodeForFormValidation;
?>	
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">All Tables</h3>
             <a href="pos_table.php?index=old_bills"  class="btn btn-pink btn-rounded m-b-5 pull-right" style="margin-top:-25px;"> <i class="fa fa-calculator" aria-hidden="true"></i> Bills Register</a>
        </div>
        <div class="panel-body">
            <div class="row">
				<?php 
...
<form action="" method="post">
        ...
        <tr class="success tbl_row" >
                    ...
                    <td ><input type="text" class="td_perior" data-id="<?php echo $row['id'];?>" style="width:60px;" id="comment<?php echo $x;?>" value="<?php echo $row['periority'] ?>" name="periority[]" /></td>

                  <td><a class="btn_delete btn btn-danger" id="<?php echo $row['id'];?>" title="Delete Item" ><i class="fa fa-trash-o"></i></a></td>
                </tr>
                                <?php $x++; }?>
                        </tbody>
		...
		<option value="<?php echo $row['id'];?>" data-id="<?php echo $row['percentage'];?>" <?php if($row['id']==$id) { echo "selected=selected"; $tax_per2=$row['percentage']/100 ;} ?>><?php echo $row['name'];?></option>
           ...
           <div class="col-md-4 col-sm-4 col-xs-12">
           	<input type="text" readonly="readonly" value="<?php echo $row2['amt']*$tax_per2;?>" name="tax1" style="width:30px;" id="tax1" />
           </div>
            </div>
            <div class="row">
           <div class="col-md-8 col-sm-8 col-xs-12">
		...
		$id2=$this->branchTax('branch_tax2');
           ...
           <div class="col-md-4 col-sm-4 col-xs-12">
           	<input type="text" style="width:30px;" value="<?php echo $row2['amt']*$tax_per1;?>" name="tax2" readonly="readonly" id="tax2" />
           </div>
            </div>
            <div class="row">
            	<div class="col-md-8 col-sm-8 col-xs-12">
...
<div class="panel-body">
            <div class="row">
                ...
                <tr><td ><strong>Bill No:</strong> <?php echo $this->getBillNumber();?></td><td ></td><td ><strong>Date:</strong> <?php echo date('d-m-Y',strtotime($this->getSoftwareDate()));?></td></tr>
                <tr><td ><strong>Table No:</strong> <?php echo $tbl_id;?></td><td ></td><td ><strong>Px:</strong></td></tr>
                <tr><td ><strong>User:</strong> <?php echo $this->getUserDetail('fname')." ".$this->getUserDetail('lname');?></td><td ></td><td ><strong>Op:</strong></td></tr>
                </table>
                    ...
                    <table >
                        ...
                        <tr class="" style=" border-bottom:1px dashed #000;" >
                                    ...
                                    <td style="text-align:center;" ><?php echo round($row['total_price']-$row['total_tax_slab_amt'],2);?>   <span style="font-size:10px;"><?php echo $this->getTaxDetail($row['tax_slab'],'tax_symbol');?></span></td>
                                </tr>
                              <?php $x++; }?>
                        ...
                        <th>Net-Amt. </th>
								...
								?>
                                 ...
                                 <td><?php echo round($row3['price_sum']-$row3['amt'],2);?></td>
                                   <td><?php echo round($row3['amt'],2);?></td>
                                   <td><?php echo $row3['price_sum'];?>  <span style="font-size:10px;"><?php echo $this->getTaxDetail($row['id'],'tax_symbol');?></span></td>
                                  </tr>
                                    <?php
								}
                        ...
                        <th>Total tax</th>
								...
								?>
                                 ...
                                 <tr>
                                   ...
                                   <td><?php echo round($row3['amt'],2);?> <span style="font-size:10px;"><?php echo $this->getTaxDetail($row3['tax_slab'],'tax_symbol');?></span></td>
                                  </tr>
                                    <?php
...
//this is function to Generate KOT
function GenerateKots($tbl_id){
...
?>
 <button class="btn btn-inverse btn-custom m-b-5 btn_change_print_status" data-id="<?php echo $row4['id'];?>"  type="button" id="<?php echo $btn_id='btn1_'.$row4['id'];?>" >
   ...
   <table class="table">
    ...
    <tr><td ><strong>User:</strong> <?php echo $this->getUserDetail('fname')." ".$this->getUserDetail('lname');?></td>
    </tr>
        <tr>
            <th>Item</th>
            <th>Qty</th>
...
?>
 <button class="btn btn-inverse btn-custom m-b-5 btn_change_print_status" data-id="<?php echo $row4['id'];?>"  type="button" id="<?php echo $btn_id='btn1_'.$row4['id'];?>" >
   ...
   <table class="table">
    ...
    <tr><td colspan="2" style="text-align:center;"><?php echo $this->getSoftwareDetail(TBL_MASTER_TABLE,$tbl_id,'name');?></td></tr>
    <tr><td colspan="2" style="text-align:center;"><strong>Date:</strong> <?php echo date('d M-Y',time());?></td></tr>
    <tr><td ><strong>User:</strong> <?php echo $this->getUserDetail('fname')." ".$this->getUserDetail('lname');?></td><td ></td></tr>
        <tr>
            <th>Item</th>
            <th>Qty</th>
    	    <th>Priority</th>
