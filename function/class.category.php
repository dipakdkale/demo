...
<div class="row">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">All Categories</h3>
                 <a href="manage_category.php?index=addpage" class="btn btn-success m-b-5 pull-right" style="margin-top:-25px;">Add Category</a>
  ...
  <span class="slider round" style="margin-left:10px; margin-top:-15px;"></span>
                                    ...
                                    <td>
               <a href="manage_category.php?index=editpage&id=<?php echo $row['id'];?>" title="Edit" rel="tooltip" data-placement="top"><i class="fa fa-edit"></i></a>  
...
<div class="wraper container-fluid">
	...
	$this->editpage('local',$id);
		...
		?>
		<script type="text/javascript">
		window.location = "manage_category.php?index=editpage&id=<?php echo $id;?>";
		</script>   
		<?php
		}
	break;
