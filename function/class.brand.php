        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">All Brands</h3>
                 <a href="manage_brand.php?index=addpage" class="btn btn-success m-b-5 pull-right" style="margin-top:-25px;">Add Brand</a>
            </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            ?>
                                <tr class="tbl_row">
                                    ...
                                    <td>
               <a href="manage_brand.php?index=editpage&id=<?php echo $row['id'];?>" title="Edit" rel="tooltip" data-placement="top"><i class="fa fa-edit"></i></a>  
    ...
    <div class="row">
        ...
        <div class="col-md-12">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" required class="form-control" name="heading" id="heading" placeholder="Brand Name">
                        </div>
			...
			case 'server':
							...
							$this->db->insert(TBL_BRAND,$insert_sql_array);
							$_SESSION['msg'] = 'Brand has been added successfully';
							?>
							<script type="text/javascript">
							window.location = "manage_brand.php?index=all";
							</script>
							<?php
							exit();
							} else {
...
<?php 
	...
	$this->db->update(TBL_BRAND,$update_sql_array,'id',$id);
	$_SESSION['msg'] = 'Brand has been updated successfully';
	?>
	<script type="text/javascript">
	window.location = "manage_brand.php?index=all";
	</script>
