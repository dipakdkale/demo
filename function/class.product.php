        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">All Products</h3>
                 ...
                 <a href="product.php?index=addpage" class="btn btn-success m-b-5 pull-right" style="margin-top:-25px;">Add Item</a>
                        ...
                        <table class="table table-bordered">
                            ...
                            ?>
                                <tr class="tbl_row">
                                    ...
                                    <td><?php echo $row['is_active'];?> 
                                    <label class="switch_new" title="Make Menu Item Active/Inactive">
  <input type="checkbox" data-id="<?php echo $row['id'];?>" id="input_product_update" <?php if($row['is_active']=='yes') echo "checked";?> value="yes">
  <span class="slider round"></span>
</label>	</td>
                                    <td>
                <a href="product.php?index=editpage&id=<?php echo $row['id'];?>" title="Edit" rel="tooltip" data-placement="top" class="btn btn-warning"><i class="fa fa-edit"></i></a>  
                |<a class="btn_delete btn btn-danger" id="<?php echo $row['id'];?>" title="Delete" ><i class="fa fa-trash-o"></i></a>
                |<a href="menu_ingradient.php?id=<?php echo $row['id'];?>" class="btn btn-primary" title="Proceed To Add Ingradient"><i class="fa fa-share" aria-hidden="true"></i></a>  </td>
                                </tr>
                             <?php $x++; }?>
                            </tbody>
                        </table>
