...
include_once("function/class.home-delivery-pos.php");
$home_delivery_pos_obj=new HomeDelivery();
        ...
        <section class="content">
            ...
            <div class="wraper container-fluid">
                <div class="page-title"> 
                    ...
                    <strong>Address:</strong> <?php echo $homepage->getSoftwareDetail(TBL_CUSTOMER,$cus_id,'address')."," .$homepage->getSoftwareDetail(TBL_CUSTOMER,$cus_id,'pincode');?><br />
                    <strong>City:</strong> <?php echo $homepage->getSoftwareDetail(TBL_CUSTOMER,$cus_id,'city');?><br />
                    <strong>Land Mark:</strong> <?php echo $homepage->getSoftwareDetail(TBL_CUSTOMER,$cus_id,'near_by');?><br />
                                     <a href="all-customer.php?type=home_delivery" class="btn btn-purple btn-rounded m-b-5 pull-right" style="margin-top:-60px;"> <i class="fa fa-arrow-left" aria-hidden="true"></i> All Customer</a>

                </div>
			<div class="row"> 
            <?php $home_delivery_pos_obj->orderList('home_delivery',$bill_id,$cus_id);?>
                    <?php $home_delivery_pos_obj->menuItemList($cus_id);?> 
                     <div class="col-md-12"><h4>New KOTs</h4></div>
                    <div class="col-md-12" id="div_kot">
                    <?php $home_delivery_pos_obj->newKots($cus_id);?>
                    </div> 
                    <div class="col-md-12"><h4>Old KOTs</h4></div>
                    <div class="col-md-12" id="div_kot_old">
                    <?php $home_delivery_pos_obj->oldKots($cus_id);?>
                    </div> 
                </div>
            </div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" id="div_print">
    	<?php $home_delivery_pos_obj->generateReceipt($cus_id);?>
      </div>
...
<?php  $homepage->deletePage(TBL_HOME_DELIVERY_ITEM_TEMP);?>
<script>
...
var info = 'pro_id=' + id;
	$.ajax({
	type: "POST",
	url: "getdata.php?index=get_product_data3",
...
var info ='cus_id='+cus_id;
	...
	$.ajax({
	type:"post",
	url:"getdata.php?index=get_product_kot_for_home_delivery",
	data:info,
	success:function(response){
	  location.reload();
	}
