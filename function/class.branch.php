        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">All Branches</h3>
                 <a href="manage_branch.php?index=addpage" class="btn btn-success m-b-5 pull-right" style="margin-top:-25px;">Add Branch</a>
            </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            ?>
                                <tr class="tbl_row">
                                    ...
                                    <td>
               <a href="manage_branch.php?index=editpage&id=<?php echo $row['id'];?>" title="Edit" rel="tooltip" data-placement="top"><i class="fa fa-edit"></i></a> |<a class="btn_delete" id="<?php echo $row['id'];?>" ><i class="fa fa-ban"></i></a>  </td>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
			...
			case 'server':
							...
							$return =true;
							if($this->Form->ValidField($heading,'empty','Please Enter Branch Name')==false)
							$return =false;
							if($return){
