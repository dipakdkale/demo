    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">All Item's List</h3>
                 <a href="manage_ingradient.php?index=addpage" class="btn btn-success m-b-5 pull-right" style="margin-top:-25px;">Add Item</a>
            </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            ?>
                                <tr class="tbl_row">
                                    ...
                                    <td>
                                     <a href="manage_ingradient.php?index=viewpage&id=<?php echo $row['id'];?>" title="View Page" rel="tooltip" data-placement="top"><i class="fa fa-search"></i></a>|
               <a href="manage_ingradient.php?index=editpage&id=<?php echo $row['id'];?>" title="Edit" rel="tooltip" data-placement="top"><i class="fa fa-edit"></i></a>  
