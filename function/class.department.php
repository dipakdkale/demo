        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">All Department</h3>
                 <a href="manage_department.php?index=addpage" class="btn btn-success m-b-5 pull-right" style="margin-top:-25px;">Add Department</a>
            </div>
                           ...
                           $sql="select * from ".TBL_DEPARTMENT." where 1 order by id desc" ;
                            ...
                            ?>
                                <tr class="tbl_row">
                                    ...
                                    <td>
               <a href="manage_department.php?index=editpage&id=<?php echo $row['id'];?>" title="Edit" rel="tooltip" data-placement="top"><i class="fa fa-edit"></i></a>  
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="heading",label for="department_id">Department Name</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="branch_id" id="branch_id">
                            	<option value="">Select Branch</option>
                                <?php 
                            $sql3="select * from ".TBL_BRANCH." where 1 order by id desc" ;
                            $result3= $this->db->query($sql3,__FILE__,__LINE__);
                            $x=1;
                            while($row3 = $this->db->fetch_array($result3))
                            {
                            ?>
                            <option value="<?php echo $row3['id'];?>" <?php if($row['branch_id']==$row3['id']) echo "selected=selected";?>><?php echo $row3['heading'];?></option>
                            <?php } ?>
                            </select>
                        ...
                        <div class="form-group" >
                            ...
                            <select class="form-control" name="department_id" id="department_id">
                                ...
                                <?php 
                            $sql4="select * from ".TBL_DEPARTMENT." where 1 order by id desc" ;
                            $result4= $this->db->query($sql4,__FILE__,__LINE__);
                            $x=1;
                            while($row4 = $this->db->fetch_array($result4))
                            {
                            ?>
                            <option value="<?php echo $row4['id'];?>" <?php if($row['id']==$row4['id']) echo "selected=selected";?>><?php echo $row4['heading'];?></option>
                            <?php } ?>
                            </select>
