        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">All Employees</h3>
                 <a href="manage_user.php?index=addpage" class="btn btn-success m-b-5 pull-right" style="margin-top:-25px;">Add Employee</a>
            </div>
                            ...
                            ?>
                                <tr class="tbl_row">
                                    ...
                                    <td><?php echo $this->getUserDetail($row['id'],'user_type');?></td>
                                     <td><?php echo $this->getUserDetail($row['id'],'fname');?></td>
                                   ...
                                   <td><?php echo $row['phone'];?></td>
                                    <td>
               <a href="manage_user.php?index=editpage&id=<?php echo $row['id'];?>" title="Edit" rel="tooltip" data-placement="top"><i class="fa fa-edit"></i></a> 
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                        ...
                        <label class="control-label">Gender</label>
                            ...
                            <div class="radio-inline">
                                <label class="cr-styled" for="example-radio4">
                                    <input type="radio" id="example-radio4" name="gender"  echo 'checked';?>  
                                    <i class="fa"></i>
                                    MALE 
                                </label>
                            </div>
                            <div class="radio-inline">
                                <label class="cr-styled" for="example-radio5">
                                    <input type="radio" id="example-radio5" name="gender" echo 'checked';?>
                                    <i class="fa"></i> 
                                    FEMALE
                                </label>
                            </div>
                    ...
                    <div class="form-group">
                            ...
                            {
                            ?>
                            <option value="<?php echo $row['id'];?>" <?php  echo "selected=selected";?>><?php echo $row['heading'];?></option>
                            <?php } ?>
                            </select>
                    ...
                    <div class="form-group">
                            ...
                            <input class="form-control" type="text" placeholder="Aadhar Card Number" id="aadhar" name="aadhar" required pattern="[0-9]{12}" title="Enter your 12 digits Aadhar Number">
                    ...
                    <div class="form-group">
                            ...
                            <input type="pan" required class="form-control" name="pan"  id="pan" placeholder="PAN Card Number">
                        </div>
                    </div>
                    <div class="col-md-6">
                    <div class="form-group">
                            <label for="phone">Phone Contact Number</label>
                            <input class="form-control" type="text" placeholder="Your Phone"  id="phone" name="phone" required pattern="[7-9]{1}[0-9]{9}" title="Enter your 10 digit mobile number only, Starting from 9,8 or 7">
                    ...
                    <div class="form-group">
                            ...
                            <input type="text"  class="form-control" name="user_role"  id="user_role" placeholder="User Type">
                        </div>
                    </div>
                    <div class="col-md-6">
                    <div class="form-group">
                            <label for="office_email">Office Email ID</label>
                            <input type="email" required class="form-control"  name="office_email" id="office_email" placeholder="Office Email ID">
                        </div>
                    </div>
                    <div class="col-md-6">
                    <div class="form-group">
                            <label for="personal_email">Personal Email ID</label>
                            <input type="email" required class="form-control"  name="personal_email" id="personal_email" placeholder="Personal Email ID">
                        </div>
                    </div>
                         <div class="col-md-6">
                    <div class="form-group">
                            <label for="c_address">Communiation Address</label>
                            <input type="text"  class="form-control" name="c_address" id="c_address" placeholder="Communication Address">
                        </div>
                    </div>
                    <div class="col-md-6">
                    <div class="form-group">
                            <label for="c_pincode">Pincode</label>
                            <input type="text"  class="form-control"  name="c_pincode" id="c_pincode" placeholder="Pincode">
                        </div>
                    </div>
                         <div class="col-md-6">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                            ...
                            <input type="text"  class="form-control"  name="p_pincode" id="p_pincode" placeholder="Pincode">
                        </div>
                    </div>
                    <div class="col-md-6">
                    <div class="form-group">
                            <label for="employee_code">Employee Code</label>
                            <input type="text"  class="form-control"  name="employee_code" id="employee_code" placeholder="Employee Code">
                        </div>
                    ...
                    <div class="form-group">
                            ...
                            <input type="text"  class="form-control" name="esci_no" id="esci_number" placeholder="ESCI No">
                        </div>
                    </div>
                    <div class="col-md-6">
                    <div class="form-group">
                            <label for="pay_grade">Pay Grade</label>
                            <input type="text"  class="form-control" name="pay_grade" id="pay_grade" placeholder="Pay Grade">
                        </div>
                    </div>
                    <div class="col-md-6">
                    <div class="form-group">
                            <label for="designation">Designation in Company</label>
                            <input type="text"  class="form-control" name="designation" id="designation" placeholder="Designation in Company">
                        </div>
                    </div>
                    <div class="col-md-6">
                    <div class="form-group">
                            <label for="pf_no">PF Number</label>
                            <input type="text"  class="form-control"  name="pf_no" id="pf_no" placeholder="PF Number">
                        </div>
                    </div>
                    <div class="col-md-6">
                    <div class="form-group">
                            <label for="uan_no">UAN Number</label>
                            <input type="text"  class="form-control"  name="uan_no" id="uan_no" placeholder="UAN Number">
                        </div>
                    </div>
                    <div class="col-md-6">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                            ...
                            <input type="text"  class="form-control" name="conveyance" id="conveyance" placeholder="Conveyance">
                        </div>
                    </div>
                    <div class="col-md-6">
                    <div class="form-group">
                            <label for="cca">CCA</label>
                            <input type="text"  class="form-control"  name="cca" id="cca" placeholder="CCA">
                        </div>
                    </div>
                    <div class="col-md-6">
                    <div class="form-group">
                            <label for="hra">HRA</label>
                            <input type="text"  class="form-control"  name="hra" id="hra" placeholder="HRA">
                        </div>
                    </div>
                    <div class="col-md-6">
                    <div class="form-group">
                            <label for="basicedu_allowance_salary">Edu Allowance</label>
                            <input type="text"  class="form-control"  name="edu_allowance" id="edu_allowance" placeholder="Edu Allowance">
                        </div>
                    </div>
                    <div class="col-md-6">
                    <div class="form-group">
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                            <label for="c_address">Communiation Address</label>
                            <input type="text"  class="form-control" value="<?php echo $row['c_address'];?>" name="c_address" id="c_address" placeholder="Communication Address">
                        </div>
                    </div>
                    <div class="col-md-6">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                            ...
                            <input type="text"  class="form-control" value="<?php echo $row['department_id'];?>" name="department_id" id="department_id" placeholder="Department">
                        </div>
                    </div>
                    <div class="col-md-6">
                    <div class="form-group">
